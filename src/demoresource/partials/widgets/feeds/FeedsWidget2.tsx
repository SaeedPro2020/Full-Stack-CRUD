...
const FeedsWidget2: React.FC<Props> = ({className, description, title, note, imgUrl}) => {
  return (
        ...
        <div className='d-flex align-items-center mb-5'>
          ...
          <div className='d-flex align-items-center flex-grow-1'>
            ...
            <div className='symbol symbol-45px me-5'>
              <img src={toAbsoluteUrl(imgUrl)} alt='' />
            </div>
            {/* end::Avatar */}
            ...
            <div className='d-flex flex-column'>
              ...
              {note && <span className='text-gray-400 fw-bold'>React, AWS Amplify, SQLite, Rest API, Sass, Bootstrap, TypeScript, Redux</span>}
            </div>
            {/* end::Info */}
          </div>
          {/* end::User */}
